  ...
  <div :id="message.id" class="sc-message">
    <div class="sc-message--content" :class="{
      ...
      <slot name="user-avatar" :message="message" :user="user">
        <!-- <div v-if="message.type !== 'system' && authorName && authorName !== 'me'" v-tooltip="authorName"
          :title="authorName" class="sc-message--avatar" :style="{
            backgroundImage: `url(${chatImageUrl})`
          }"></div> -->
        <van-popover v-model="showPopover" trigger="click" :actions="[{ text: authorName }]" theme="dark">
          <template #reference>
            <div :title="authorName" class="sc-message--avatar" :style="{
              backgroundImage: `url(${chatImageUrl})`
            }"></div>
          </template>
        </van-popover>
      ...
      <TextMessage v-if="message.type === 'text'" :message="message" :message-colors="messageColors"
        :message-styling="messageStyling" @remove="$emit('remove')">
